...
- [Windows 11, 10, etc](https://en.wikipedia.org/wiki/List_of_Microsoft_Windows_versions)
- [Distros Linux](https://en.wikipedia.org/wiki/List_of_Linux_distributions)
...
- [MacOS](https://www.apple.com/br/os/macos/)
